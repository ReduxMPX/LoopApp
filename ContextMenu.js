...
ContextMenu.js:46 Error: <path> attribute d: Expected path command, "….44-4.005-4.901z\u003Ccircle cx=".
createItemMarkup @ ContextMenu.js:46
(anonymous) @ ContextMenu.js:31
getMenuItemsNode @ ContextMenu.js:30
ContextMenu @ ContextMenu.js:7
(anonymous) @ VM355:31
ContextMenu.js:46 Error: <path> attribute d: Expected path command, "….44-4.005-4.901z\u003Ccircle cx=".
createItemMarkup @ ContextMenu.js:46
(anonymous) @ ContextMenu.js:31
...
(anonymous) @ VM355:39
undefined
const copyIcon = `<svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" fill="none" stroke="currentColor" stroke-width="1.5" class="bi bi-bell-fill" viewBox="0 0 16 16">
...
const menuItems = [
  {
    content: `${copyIcon} Soleware Fact`,
    events: {
      click: (e) => showFact()
      // mouseover: () => console.log("Copy Button Mouseover")
      // You can use any event listener from here
